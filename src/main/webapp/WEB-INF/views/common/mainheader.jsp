  ...
  <body>
    ...
    <header>
      ...
      <div class="menu" style="height: max-content">
        <div><a href="${pageContext.request.contextPath}/studio765/765_advantage" class="menubtn">ABOUT US</a></div>
        <div><a href="${pageContext.request.contextPath}/studio765/765_pickYourPY" class="menubtn">시스템 소개</a></div>
