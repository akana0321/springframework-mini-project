    ...
    <div id="product-container">
      ...
      <div style="height:200px;">
        <%-- <%@ include file="/WEB-INF/views/pickPY/svg.jsp" %> --%>
          <img id="background-image" src="${attach.aoname }" alt="" />
      </div>
      <!-- Optional JavaScript -->
      ...
      <div style="width:100%;">
        ...
        <div id="pCS" type="button" class="btn btn-lg btn-block gray-button px-3"
          style="color: white; width: fit-content; margin: 1em auto">
          문의하기
        </div>
      </div>
      ...
      <div class="row" style="margin:0; justify-content: left; margin: 1.5em 2em; width:85%; height: 30%; ">
        ...
        <div class="col-6" style="width: 20%; height:20%; text-align:center;">
          <img src="${recommandAttach1.aoname }" alt="" width="150rem" height="150rem" />
          <span style="font-size: large;"><br />${recommand1.pname}</span>
        </div>
        <div class="col-6" style="width: 20%; height:20%; text-align:center;">
          <img src="${recommandAttach2.aoname }" alt="" width="150rem" height="150rem" />
          <span style="font-size: large;"><br />${recommand2.pname}</span>
        </div>
      </div>
    </div>
